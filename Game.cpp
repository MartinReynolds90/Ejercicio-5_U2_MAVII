...
void Game::DrawGame()
{
    ...
    /*sf::RectangleShape controlRectangle;
    controlRectangle.setFillColor(sf::Color::Black);
    controlRectangle.setPosition(controlBody->GetPosition().x - 10, controlBody-> GetPosition().y -10);
    wnd->draw(controlRectangle);*/
}
...
void Game::DoEvents()
{
    ...
    if (Keyboard::isKeyPressed(Keyboard::Left))
        controlBody->ApplyLinearImpulseToCenter(b2Vec2(-30.0f, 0.0f), true);
...
void Game::InitPhysics()
{
    ...
    groundBody->SetTransform(b2Vec2(50.0f, 70.0f), 35.0f);
    ...
    controlBody = Box2DHelper::CreateRectangularDynamicBody(phyWorld, 5.0f, 10.0f, 5.0f, 0.6f, 0.0f);//CONSIGNA 1 //////////////////////////////
    controlBody->SetTransform(b2Vec2(10.0f, 10.0f), 0.0f);
